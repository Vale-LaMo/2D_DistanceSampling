...
Finally, the `preddata` dataset (Excel file) should include the following columns (order matters):
...
write.csv(pp,"output/2023-08-31-DSMresults_impala.csv")
...
pp.uncertainty <- read.csv("output/2023-07-08-DSMresults2015_grigio.csv")
