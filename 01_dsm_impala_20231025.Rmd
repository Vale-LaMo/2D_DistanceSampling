...
- `area`: surface of the study area, in km\(^2\)
...
and additional, optional columns can be added, to describe the segments in terms of environmental covariates (e.g., information on habitats, distance from water sources or from anthropic areas such as villages, altitude, ...).
...
Finally, we can plot the results to show the abundances within the study area, and the corresponding uncertainty map
