...
params:
  species_name: duiker
  input_file: distdata_duiker.xlsx
...
# # figura per paper, sia duiker sia impala
# tiff(paste("figs/avoidance_plot_",params$species_name,".tiff",sep = ""),
...
# # figura per paper aggiornata 2024-08-08, sia duiker sia impala
...
if(params$species_name == "impala") {
  p <- ggplot(data_clean, aes(x = perp_dist, y = forw_dist)) +
    ...
    coord_fixed() + # Keep aspect ratio equal
    guides(x = "axis_truncated", y = "axis_truncated") +
    annotation_custom(rasterGrob(logo, width = unit(2.5, "cm"),
                                 height = unit(2.5, "cm")),
                      xmin=300, ymin=300)
  # Print the plot
  # print(p)
...
# plotfit.x.red.impala(x[x<=w],fitVU,nclass=20,nint=100);rug(x[x<=w])
# dev.off()
```
...
# # paper fig for duiker
# tiff(paste("figs/cds_plot_",params$species_name,".tiff",sep = ""), res=300,
#      compression = "lzw", width = 14, height = 9.5, units = "cm", pointsize = 10)
# plot(cds.hr, main="", xlab = "")
# dev.off()
...
# tiff(paste("figs/cds_plot_",params$species_name,".tiff",sep = ""), res=300,
#      compression = "lzw", width = 14, height = 9.5, units = "cm", pointsize = 10)
# plot(cds.hr, main="", xlab = "Distance (m)")
# dev.off()

## figure aggiornate 2024-08-08
logo_path <- paste("logos/", params$species_name, "_logo.png",sep = "")
logo <- readPNG(logo_path)
...
# 519 km2 area della prediction grid
CDS	27.759 CV	0.402	
2D-DS	63.665	cv 0.687	surveyed area 105.657286

63.665 : 105.66 = x : 519
duiker 2d ds 63.665 * 519 / 105.66
duiker cds 27.759 * 519 / 105.66

impala 2d ds 975.027 * 519 / 266.161306
impala cds 828.244 * 519 / 266.161306
