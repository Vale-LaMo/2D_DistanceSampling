...
We now produce histograms and boxplots to identify outliers and we apply a standard 5% truncation:
...
Using a truncation distance of `r params$trunc_perp_dist`%, we remove `r no_data` records.   
...
**Please note that this is going to be = 1 for solitary species (this result can be overlooked)**
